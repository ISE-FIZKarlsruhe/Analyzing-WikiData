...
start = 33897277             #define the start node
goal = 1                #define the goal node
maxPathlength = 100       #define the maximal pathlength

#Action parameter
rebuildDict = True      #Specifies wheather or not the dictionary should be rebuild (Has to be set to True for the first run only)
followAllPaths = False  #if True returns all paths from start to X below the set maxPathlength (default: False)
